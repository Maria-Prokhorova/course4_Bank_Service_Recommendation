...
import org.skypro.banking_service.rule_system.static_rules.rules.StaticRuleInvest500Imp;
import org.skypro.banking_service.rule_system.static_rules.rules.StaticRuleSimpleCreditImp;
import org.skypro.banking_service.rule_system.static_rules.rules.StaticRuleTopSavingImp;
...
public class RulesTest {
    ...
    @Autowired
    StaticRuleInvest500Imp invest500Rule;

    @Autowired
    StaticRuleTopSavingImp topSavingRule;

    @Autowired
    StaticRuleSimpleCreditImp simpleCreditRule;
    ...
    void shouldReturnRecommendationInvest500() {
        ...
        Optional<RecommendationDto> result = invest500Rule.checkOutStaticRule(userId);
    ...
    void shouldReturnRecommendationTopSaving() {
        ...
        Optional<RecommendationDto> result = topSavingRule.checkOutStaticRule(userId);
        assertEquals(new RecommendationDto(
    ...
    void shouldReturnRecommendationSimpleCredit() {
        ...
        Optional<RecommendationDto> result = simpleCreditRule.checkOutStaticRule(userId);
        assertEquals(new RecommendationDto(
