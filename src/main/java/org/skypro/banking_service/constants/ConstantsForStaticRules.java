...
public class ConstantsForStaticRules {

    private ConstantsForStaticRules() {
    }
    ...
    public static final long LIMIT_TOP_SAVING = 50_000L;
    public static final long LIMIT_INVEST_500 = 1_000L;
    public static final long LIMIT_SIMPLE_CREDIT = 100_000L;

    public static final String PRODUCT_ID_TOP_SAVING = "59efc529-2fff-41af-baff-90ccd7402925";
    ...
    public static final String DESCRIPTION_INVEST_500 = """
    ...
    public static final String DESCRIPTION_SIMPLE_CREDIT = """
            Откройте мир выгодных кредитов с нами!
            Ищете способ быстро и без лишних хлопот получить нужную сумму? Тогда наш выгодный кредит — 
            именно то, что вам нужно! Мы предлагаем низкие процентные ставки, гибкие условия и индивидуальный 
